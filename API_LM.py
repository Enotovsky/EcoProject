...
class EcoScanAI:
    def __init__(self, base_url="http://localhost:1234/v1", api_key="lm-studio"):
        ...
        self.system_prompt = (
            ...
            "5. Actionable Eco Tips & Alternatives: For each item, provide a specific, practical recommendation in Russian under the 'eco_tip' key.\n"
            "   - If the item has a high or medium CO2 footprint (Meat, Dairy, Plastic, certain Sweets), explicitly suggest a greener product analog or alternative that the user could buy instead (e.g., 'Замените говядину на птицу или растительное мясо (тофу, соя)', 'Вместо пакета используйте многоразовый шоппер').\n"
            "   - If the item is already an eco-friendly choice (Vegetables, Fruits), encourage the choice and suggest a tip for sustainable storage or local sourcing (e.g., 'Отличный эко-выбор! Старайтесь брать местные сезонные овощи без пластиковой упаковки').\n"
            "   - Keep it concise (max 20-25 words) but highly informative.\n\n"
            ...
            "  'eco_tip': 'String. Personalized advice and product alternative in Russian'\n"
            "}\n\n"
            "Few-Shot Example:\n"
            "User Input:\n"
            "ООО ПЯТЕРОЧКА\n"
            ...
            "    'co2_coefficient': 1.2,\n"
            "    'eco_tip': 'Отличный выбор базы! Старайтесь покупать местный хлеб в бумажной упаковке или без нее.'\n"
            "  },\n"
            "  {\n"
            ...
            "    'co2_coefficient': 3.0,\n"
            "    'eco_tip': 'Замените одноразовый пластиковый пакет на многоразовую тканевую сумку (шоппер), чтобы избежать микропластика.'\n"
            "  },\n"
            "  {\n"
            ...
            "    'eco_tip': 'Замените мясную колбасу на аналоги из растительного белка (соя, пшеница) или выбирайте птицу вместо говядины.'\n"
            "  }\n"
            "]\n\n"
