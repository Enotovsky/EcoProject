...
class EcoScanAI:
    def __init__(self, base_url="http://localhost:1234/v1", api_key="lm-studio"):
        ...
        self.system_prompt = (
            ...
            "5. Actionable Eco Tips & Concrete Alternatives: Under the 'eco_tip' key, you MUST provide a unique, highly specific advice in Russian.\n"
            "   - RULE 1: NEVER use generic phrases like 'choose eco-friendly alternatives'. You must name EXACT substitute products.\n"
            "   - RULE 2: If the item is Meat/Dairy (high CO2), suggest specific lower-CO2 analogs. Example for Cow Milk: 'Попробуйте овсяное или соевое молоко — их производство выделяет в 3 раза меньше CO2.' Example for Beef/Pork: 'Замените на мясо птицы (курица, индейка) или богатые белком растительные продукты (чечевица, тофу).'\n"
            "   - RULE 3: If the item is Sweets/Snacks, suggest: 'Выбирайте темный шоколад (он экологичнее молочного) или натуральные сладости (пастила, сушеные яблоки, орехи).'\n"
            "   - RULE 4: If the item is Vegetables/Fruits, suggest: 'Отличный выбор! Старайтесь брать сезонные локальные овощи на развес, используя многоразовые эко-мешочки (фруктовки) вместо фасовочных пакетов.'\n"
            "   - RULE 5: If the item is Packaging/Bags, suggest: 'Купите плотный тканевый шоппер. Он окупится за месяц и избавит планету от сотен пластиковых пакетов, разлагающихся 400 лет.'\n"
            "   - Make the advice engaging, practical, and highly relevant to the specific 'clean_name'. Do not repeat the exact same text for different items.\n\n"
            ...
            "  'eco_tip': 'String. Personalized advice and exact product alternative in Russian'\n"
            "}\n\n"
            "Few-Shot Example:\n"
            "User Input:\n"
            "ООО ПЯТЕРОЧКА\n"
            ...
            "3. Колбаса Вареная 250г 150.00\n"
            "4. Молоко 3.2% 1л 80.00\n"
            "ИТОГО: 290.00\n\n"
            ...
            "    'co2_coefficient': 1.2,\n"
            "    'eco_tip': 'Хлеб имеет низкий след. Выбирайте выпечку из пекарен у дома в бумажной упаковке — это снижает транспортный след и расход пластика.'\n"
            "  },\n"
            "  {\n"
            ...
            "    'co2_coefficient': 3.0,\n"
            "    'eco_tip': 'Купите складной тканевый шоппер и носите его в кармане. Это сэкономит вам около 2000 рублей в год на пакетах на кассе.'\n"
            "  },\n"
            "  {\n"
            "    'raw_name': '3. Колбаса Вареная 250г 150.00',\n"
            "    'clean_name': 'Колбаса вареная 250г',\n"
            "    'category': 'Мясо и Птица',\n"
            "    'co2_coefficient': 15.0,\n"
            "    'eco_tip': 'Мясное производство требует огромных ресурсов. Попробуйте заменить колбасу на ветчину из индейки (след ниже в 2 раза) или веганскую колбасу из сейтана.'\n"
            "  },\n"
            "  {\n"
            "    'raw_name': '4. Молоко 3.2% 1л 80.00',\n"
            "    'clean_name': 'Молоко 3.2% 1л',\n"
            "    'category': 'Молочные продукты и Яйца',\n"
            "    'co2_coefficient': 4.5,\n"
            "    'eco_tip': 'Коровы выделяют много метана. Попробуйте овсяное или миндальное молоко — они отлично подходят для кофе и требуют в разы меньше воды для производства.'\n"
            "  }\n"
            "]\n\n"
