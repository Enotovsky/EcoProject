    ...
    <div className="relative min-h-screen w-full flex flex-col items-center pt-8 pb-32">
      ...
      <div className="relative z-10 w-full max-w-[95%] xl:max-w-7xl px-4 flex flex-col items-center justify-center text-center">
        ...
        <motion.div 
          ...
          className="flex flex-wrap justify-center items-center gap-4 md:gap-8 mb-4 relative z-20 w-full"
        >
          <span className="font-pixel text-[8.5vw] sm:text-5xl md:text-7xl lg:text-[5.5rem] text-black leading-none drop-shadow-[4px_4px_0_#fff]">
            ПРЕВРАТИТЕ
          </span>
        ...
        >
          <span className="font-handwriting text-[18vw] sm:text-7xl md:text-9xl text-black leading-none -rotate-2">
            В ОТЧЁТ
          </span>
        </motion.div>
        ...
        <motion.div 
          ...
          className="flex flex-wrap justify-center items-center gap-3 relative z-30 w-full"
        >
          <span className="font-pixel text-[7vw] sm:text-4xl md:text-6xl lg:text-[4.5rem] text-black leading-none drop-shadow-[3px_3px_0_#fff]">
            О УГЛЕРОДНОМ
          </span>
        </motion.div>
        ...
        >
          ...
          <span className="font-pixel text-[9vw] sm:text-4xl md:text-6xl lg:text-[5rem] text-black leading-none drop-shadow-[3px_3px_0_#fff]">
            ЛЕДЕ
          </span>
        </motion.div>
