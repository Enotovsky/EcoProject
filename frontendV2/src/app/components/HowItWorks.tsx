  ...
  return (
    <div id="how" className="relative py-24 w-full flex flex-col items-center min-h-[100vh]">
      <div className="w-full max-w-[95%] xl:max-w-7xl px-4 relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-6xl mx-auto h-[1400px] md:h-[800px] lg:h-[700px] mt-8">
          ...
          {/* Bottom Row */}
          {/* Note 3 - Bottom Center (under Note 2) */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
          ...
          {/* Note 4 - Bottom Right (under Paperclip) */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
